...
export const PollAnalytics: React.FC<PollAnalyticsProps> = ({ poll }) => {
 ...
 {payload[0].payload.percentage}% <span className="text-[10px] uppercase tracking-normal text-[var(--text-secondary)]">du total</span>
 </p>
 </div>
 );
 }
 ...
 className="text-4xl font-black text-[var(--text-main)] tracking-tighter"
 >
 {poll.totalVotes}
 </motion.p>
 <p className="text-[10px] text-[var(--text-secondary)] font-black uppercase tracking-[0.2em]">Flux Total</p>
 </div>
 </div>
