...
export const Topbar = () => {
  ...
  return (
    <motion.header
      ...
      className="sticky top-4 z-40 mx-4 lg:mx-8 px-6 py-3 bg-white/40 dark:bg-slate-900/60 backdrop-blur-2xl border border-slate-200 dark:border-white/5 rounded-2xl flex items-center justify-between shadow-sm dark:shadow-[0_8px_32px_rgba(0,0,0,0.2)]"
    >
      <div className="flex items-center flex-1">
        <div className="relative w-full max-w-md group">
          ...
          <input
            ...
            className="w-full bg-slate-100/50 dark:bg-black/20 border border-transparent focus:border-primary/50 focus:bg-white dark:focus:bg-slate-950 rounded-xl py-2 pl-10 pr-4 text-sm text-slate-800 dark:text-white placeholder-slate-400 outline-none transition-all duration-300 shadow-inner"
          />
        </div>
      </div>
