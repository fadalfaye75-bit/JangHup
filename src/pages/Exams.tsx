                  ...
                  header={
                    <div className="flex justify-between items-start w-full gap-3">
                      ...
                      <div className="flex items-center gap-1 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
                        <Button variant="ghost" size="sm" onClick={() => handleShareWhatsApp(exam)} className="p-2 h-auto text-gray-600 dark:text-gray-400 hover:text-[#25D366]">
                          <Share2 size={16} />
                        </Button>
                        {canManage && !isPast && (
                          <>
                            <Button variant="ghost" size="sm" onClick={() => handleEdit(exam)} className="p-2 h-auto text-gray-600 dark:text-gray-400 hover:text-blue-500">
                              <Edit2 size={16} />
                            </Button>
                            <Button variant="ghost" size="sm" onClick={() => handleDelete(exam.id)} className="p-2 h-auto text-gray-600 dark:text-gray-400 hover:text-danger">
                              <Trash2 size={16} />
                            </Button>
                          </>
                        )}
