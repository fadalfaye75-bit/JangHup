...
export const Resources: React.FC = () => {
 ...
 default: return <BookOpen className="text-[var(--text-secondary)]"size={24} />;
 }
 };
 ...
 {/* Filters & Search */}
 <GlassCard className="p-6 rounded-[32px] border-[var(--glass-border)] shadow-2xl"tilt={false}>
 ...
 <Filter className="absolute left-5 top-1/2 -translate-y-1/2 text-[var(--text-secondary)] group-focus-within:text-primary transition-colors"size={18} />
 <select 
 value={filterType}
 onChange={(e) => setFilterType(e.target.value as any)}
 className="w-full pl-14 pr-6 py-4 bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-2xl outline-none focus:ring-2 focus:ring-primary/50 transition-all text-sm font-black uppercase tracking-widest text-[var(--text-main)] appearance-none cursor-pointer"
 >
 ...
 <div className="relative group">
 <BookOpen className="absolute left-5 top-1/2 -translate-y-1/2 text-[var(--text-secondary)] group-focus-within:text-primary transition-colors"size={18} />
 <select 
 value={filterSubject}
 ...
 className="group"
 >
 <GlassCard className="h-full flex flex-col p-0 overflow-hidden border-[var(--glass-border)] hover:border-primary/30 transition-all duration-500"tilt={true}>
 {/* Card Header with Icon & Actions */}
 <div className="p-8 flex items-start justify-between border-b border-[var(--glass-border)] relative z-10">
 <div className="flex items-center gap-5">
 <div className="w-16 h-16 rounded-2xl bg-[var(--glass-bg)] flex items-center justify-center border border-[var(--glass-border)] shadow-inner group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(108,99,255,0.2)] transition-all duration-500">
 ...
 <h3 className="font-black text-[var(--text-main)] truncate pr-2 tracking-tight text-lg leading-tight"title={res.title}>
 {res.title}
 </h3>
 </div>
 </div>
 ...
 className="p-2.5 bg-[var(--glass-bg)] hover:bg-[var(--glass-bg-hover)] text-[var(--text-secondary)] hover:text-primary rounded-xl transition-all"
 >
 <Edit3 size={18} />
 </button>
 <button 
 ...
 <p className="text-sm text-[var(--text-secondary)] line-clamp-3 leading-relaxed font-medium group-hover:text-[var(--text-main)] transition-colors duration-500">
 {res.description ||"Aucune description fournie pour cette ressource."}
 </p>
 </div>

 {/* Footer Stats & Actions */}
 <div className="px-8 py-6 bg-[var(--glass-bg)] border-t border-[var(--glass-border)] flex items-center justify-between mt-auto relative z-10">
 ...
 className="flex items-center gap-2 px-6 py-3 bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-xl text-[10px] font-black uppercase tracking-widest text-[var(--text-main)] hover:bg-[var(--glass-bg-hover)] transition-all"
 >
 <Eye size={16} />
 Aperçu
 </button>
 ...
 <div className="col-span-full text-center py-32 glass-ultra rounded-[48px] border-2 border-dashed border-[var(--glass-border)]">
 <div className="w-28 h-28 bg-[var(--glass-bg)] rounded-full flex items-center justify-center mx-auto mb-8 border border-[var(--glass-border)] shadow-inner">
 <BookOpen size={56} className="text-[var(--text-main)]"/>
 </div>
 <h3 className="text-2xl font-black text-[var(--text-main)] tracking-tight">Aucune ressource trouvée</h3>
 <p className="text-[var(--text-secondary)] font-medium mt-3 max-w-xs mx-auto">Le système n'a trouvé aucune archive correspondant à vos critères de recherche.</p>
 <button 
 onClick={() => { setSearchTerm(''); setFilterType('all'); setFilterSubject('all'); }}
 className="mt-10 px-8 py-4 bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] text-primary hover:text-[var(--text-main)] hover:bg-[var(--glass-bg-hover)] transition-all"
 >
 ...
 <label className="block text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-[0.3em] mb-3 ml-1">Titre</label>
 <input 
 type="text"
 required
 ...
 <div className="space-y-3">
 <label className="block text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-[0.3em] mb-3 ml-1">Type de ressource</label>
 ...
 : 'border-[var(--glass-border)] bg-[var(--glass-bg)] text-[var(--text-secondary)] hover:border-[var(--glass-border)]'
 }`}
 >
 ...
 <div className="space-y-3">
 <label className="block text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-[0.3em] mb-3 ml-1">Lien URL</label>
 <input 
 type="url"
 required
 value={formData.url}
 ...
 <div className="space-y-3">
 <label className="block text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-[0.3em] mb-3 ml-1">Description</label>
 <textarea 
 rows={3}
 ...
 className="absolute -top-16 right-0 p-3 text-[var(--text-secondary)] hover:text-[var(--text-main)] transition-colors bg-[var(--glass-bg)] rounded-full border border-[var(--glass-border)]"
 >
 <X size={24} />
 </button>
 <img 
 src={previewImage} 
 alt="Preview"
 className="max-w-full max-h-full rounded-[32px] shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-[var(--glass-border)] object-contain"
